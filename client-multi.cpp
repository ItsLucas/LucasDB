...
thread_local boost::random::taus88 keygen; // global key generator
thread_local boost::random::discrete_distribution<int> dist;
thread_local boost::random::uniform_int_distribution<> vdist(1, 100000000);
thread_local boost::random::uniform_int_distribution<> kdist(1, 20000000);
